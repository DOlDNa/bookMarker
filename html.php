...
'<style>#search,#url,[type=text]{color:#bec3cd;background-color:rgba(12,16,38,.9);border:1px solid transparent;font-size:large;padding:.4em .8em;width:35%}#search{margin-bottom:1em}*{box-sizing:border-box;overflow-wrap:anywhere}.disabled{opacity:.2}.nav{font-size:xx-large;vertical-align:top;padding-left:.5em;padding-right:.5em}a,body{color:#bec3cd;text-decoration:none}a:hover{opacity:.8}address{margin:1em}#add{margin-left:.5em}aside,h1,header form,main ul:nth-child(3),main ul:last-child,footer form{text-align:center}aside{border:thin solid dimgray;border-left:none;border-right:none;margin:0 auto 1em;padding:1em;width:40%}body,div,main,main ul,footer{display:flex}body,header,menu,main ul{margin:0;padding:0}body{background-color:#2e2f37;flex-flow:column;height:100vh}div,footer form{flex:1}footer{bottom:0;padding:1em}footer a{align-self:center;background-color:rgba(255,255,255,.8);padding:.1em}h1 a{color:ghostwhite;font:normal 400 1em "URW Gothic";letter-spacing:5pt}h1 img{vertical-align:middle;margin-right:.4em;animation:bounce 2s}h1{margin:0;padding-top:.5em}header,footer{background-color:rgba(12,16,38,.5);position:sticky}header{box-shadow:0 1px 5px 1px rgba(12,16,38,.4);top:0;z-index:10}main ul li mark{align-content:center;background:inherit;color:#fff;', ($sort_by_time ? '' : 'cursor:move;'), 'padding-left:1em;padding-right:1em}main ul li:first-child{display:flex;text-align:left;width:100%}main ul li:not(:first-child){padding-left:1em;padding-right:1em}main ul li:nth-child(2),main ul li:nth-child(3){text-align:right;white-space:pre}main ul:nth-child(even),.current{background-color:rgba(12,16,38,.2)}main ul{align-items:center}main{flex-direction:column;margin-bottom:5em;width:85vw}menu a{position:relative}menu a{display:block;padding:1.5em;width:100%}main ul li a{display:block;padding-bottom:1.5em;padding-top:1.5em;width:100%}menu a,main ul{border-bottom:solid thin dimgray}menu,main ul{list-style:none}menu{border-right:solid thin dimgray;width:15vw}@keyframes bounce{0%,10%{transform:translateY(-100px)}20%,40%,60%{transform:translateY(0px)}30%{transform:translateY(-20px)}45%{transform:translateY(-4px)}}@media(max-width:800px){footer{padding:.5em}menu a,main ul li:nth-child(3){padding:1em;white-space:normal}main ul{flex-direction:column;align-items:flex-start}main ul li{width:auto!important}}</style>',
...
if (isset($cl))
{
	...
	while ($i < $d)
	{
		...
		'<li><mark>', GRABHERE[$lang], '</mark><a href="', $uri[$i], '" rel="noopener noreferrer" target="_blank" tabindex=1>', h($name[$i]), '</a></li>',
