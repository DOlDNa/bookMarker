...
if (isset($cl))
{
	...
	while ($i < $d)
	{
		...
		'<li><mark>', GRABHERE[$lang], '</mark><a href="', $uri[$i], '" rel="noopener noreferrer" target="_blank" tabindex=1 data-accesskey=', $i, '><kbd>Alt + Shift + ', $i, '</kbd>', h($name[$i]), '</a></li>',
